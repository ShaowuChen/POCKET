...
if __name__ == '__main__':
    ...
    pruning_remain_rates = [0.41, 0.41, 0.16, 0.27, 0.20, 0.19, 0.19, 0.21, 0.31, 0.58, 0.29, 0.72, 0.71, 0.70, 0.29,
                            0.35, 0.35, 0.69, 0.23, 0.01, 0.01, 0.18, 0.29, 0.21, 0.56, 0.59, 0.52, 0.59, 0.50, 0.78]
    ...
    for dth, dataset_name in enumerate(dataset_names):
        ...
        for run in range(arguments.num_runs):
            ...
            'Too time-consuming, we do not reimplement sorkcet for ROCKET_PPV'
            '''
            ...
            gs = GridSearchCV(
                PROCKETPruner(n_class, None, None, None, remain_num=remain_num,stop_thr=arguments.stop_thr, epoch=arguments.num_epochs, _dataset_name=dataset_name),
            ...
            if 'results' not in locals():
                writer = pd.ExcelWriter(arguments.output_path + '/RocketResults_PPV.xlsx')
